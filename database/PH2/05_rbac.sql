...
GRANT SELECT, INSERT, UPDATE ON QLYTE_06.BENHNHAN TO ROLE_DIEUPHOIVIEN;
...
GRANT UPDATE (TENTHUOC, LIEUDUNG) ON QLYTE_06.DONTHUOC TO ROLE_BACSI;
...
GRANT UPDATE (QUEQUAN, SODT)
ON QLYTE_06.NHANVIEN TO ROLE_DIEUPHOIVIEN;

GRANT UPDATE (QUEQUAN, SODT)
ON QLYTE_06.NHANVIEN TO ROLE_BACSI;

GRANT UPDATE (QUEQUAN, SODT)
ON QLYTE_06.NHANVIEN TO ROLE_KYTHUATVIEN;
...
GRANT SELECT ON NHANVIEN TO ROLE_DIEUPHOIVIEN;
GRANT SELECT ON NHANVIEN TO ROLE_BACSI;
GRANT SELECT ON NHANVIEN TO ROLE_KYTHUATVIEN;
